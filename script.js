...
let visitorIP       = null;
let soundMuted      = localStorage.getItem('lemon_muted') === '1';
...
(function injectMuteToggle() {
  ...
  btn.addEventListener('click', (e) => {
    ...
    localStorage.setItem('lemon_muted', soundMuted ? '1' : '0');
    render();
...
function generateReceipt(username) {
  ...
  cx.fillText('Lemon Gaming', W/2, 170);
  ...
  cx.fillText('© 2026 Lemon Gaming · play responsibly · 18+', W/2, 662);
  ...
  link.download = `LemonGaming_Receipt_${username}_${receiptId}.png`;
